    ...
    private OnItemSelectedListener itemSelectedListener = new OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView<?> arg0, View arg1, int position,
            ...
            if (spinner_subject.getSelectedItem().toString() != null &&
                ...
                Toast.makeText(synchronise.this, "Please select subject... ", Toast.LENGTH_SHORT).show();
            }
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* spinner_fac = (Spinner) findViewById(R.id.fac);
        ...
        spinner_center = (Spinner) findViewById(R.id.cent_sync);
        ...
        */
        ...
        spinner_batch = (Spinner) findViewById(R.id.batch_sync);
        ...
        spinner_class = (Spinner) findViewById(R.id.myclass_sync);
        ...
        submit = (Button) findViewById(R.id.submit_cal_sync);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkerForstudent()) {
                    new SweetAlertDialog(synchronise.this, SweetAlertDialog.WARNING_TYPE)
                            ...
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                ...
                                public void onClick(SweetAlertDialog sDialog) {
                                    ...
                                    if (send == null) {
                                        Toast.makeText(synchronise.this, "Please mark Absent,Present or Leave", Toast.LENGTH_SHORT).show();
                                    } else {
                                        new time().execute();
                    ...
                    Toast.makeText(synchronise.this, "Please Select all fields!!!", Toast.LENGTH_SHORT).show();
                }
	...
	*/
    ...
    protected void setlist() {
        ...
        dialogReg = new Dialog(synchronise.this);
    ...
    private void viewall() {
        ...
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(synchronise.this, android.R.layout.simple_list_item_checked, categories_code);
    ...
    private class time extends AsyncTask<String, Void, String> {
        ...
        final SweetAlertDialog pDialog = new SweetAlertDialog(synchronise.this, SweetAlertDialog.PROGRESS_TYPE)
        ...
        protected String doInBackground(String... urls) {
            ...
            String url = "http://176.32.230.250/anshuli.com/sharpenup2/synchronise.php";
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (account.equals("SUCCESS")) {
                    ...
                    pDialog.setTitleText("Data Synchronised!")
                            .setConfirmText("OK")
    ...
    private class studentsview extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(synchronise.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
