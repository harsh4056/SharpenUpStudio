    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new SweetAlertDialog(view.this, SweetAlertDialog.WARNING_TYPE)
                        .setTitleText("Are you sure you want to view time table?")
...
*/
    ...
    private class studentsview extends AsyncTask<String, Void, String> {
        final SweetAlertDialog pDialog = new SweetAlertDialog(view.this, SweetAlertDialog.PROGRESS_TYPE)
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (crashPrevent == 1) {
                    ...
                    Toast.makeText(view.this, "Data Empty,there might be no class scheduled these days", Toast.LENGTH_SHORT).show();
                }
