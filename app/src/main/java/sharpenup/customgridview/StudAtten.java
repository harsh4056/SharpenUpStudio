        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (universalChecker()) {
                    ...
                    new SweetAlertDialog(StudAtten.this, SweetAlertDialog.WARNING_TYPE)
                            .setTitleText("Are you sure you want to view this students' attendance?")
...
*/
    ...
    private class time extends AsyncTask<String, Void, String> {
        ...
        final SweetAlertDialog pDialog = new SweetAlertDialog(StudAtten.this, SweetAlertDialog.PROGRESS_TYPE)
