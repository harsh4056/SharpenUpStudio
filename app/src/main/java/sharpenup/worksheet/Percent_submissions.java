        ...
        */
        ...
        sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new SweetAlertDialog(Percent_submissions.this, SweetAlertDialog.WARNING_TYPE)
...
*/
    ...
    private class time extends AsyncTask<String, Void, String> {
        final SweetAlertDialog pDialog = new SweetAlertDialog(Percent_submissions.this, SweetAlertDialog.PROGRESS_TYPE)
